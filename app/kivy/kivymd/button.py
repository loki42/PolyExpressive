...
<BaseOutlineButton>:
    canvas:
        ...
        Line:
            width: self.outline_width if self.outline_width > 0 else 0.00000001
            joint: "miter"
            # rectangle: (self.pos[0]+(self.outline_width/2), self.pos[1]+(self.outline_width/2), self.size[0], self.size[1])
            rectangle: (self.pos[0]+(self.outline_width), self.pos[1]+self.outline_width, self.size[0]-(self.outline_width*2), self.size[1]-(self.outline_width*2))
        Color:
            rgba: self._current_button_color
        Rectangle:
            size: (self.size[0]-(self.outline_width*4), self.size[1]-(self.outline_width*4))
            pos: (self.pos[0]+self.outline_width*2, self.pos[1]+self.outline_width*2)
    content: content
    height: dp(36)
...
class BaseOutlineButton(BaseFlatButton):
...
class MDOutlineButton(BaseOutlineButton, BasePressedButton):
    pass
