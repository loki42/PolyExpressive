...
"Chase Bliss:Condor":{
    ...
    "Expression": {"type": "CC", "controller":100, "curve":"1"},
    "Engage Last Preset": {"type": "CC", "controller":102, "enum":{"Last Saved Preset": 127, "Bypass": 0}},
    "Bypass": {"type": "CC", "controller":103, "enum":{"Enabled": 127, "Drive On Bypassed": 85, "Drive Off Engaged": 45, "Bypass":0}},
    "Preset": {"type": "PC", "value":{"min":0, "max":122}}
    },
...
"Chase Bliss:Thermae":{
    "Mix": {"type": "CC", "controller":14, "curve":"1"},
    "LPF": {"type": "CC", "controller":15, "curve":"1"},
    "Regen": {"type": "CC", "controller":16, "curve":"1"},
    "Glide": {"type": "CC", "controller":17, "curve":"1"},
    "Int 1 (Speed)": {"type": "CC", "controller":18, "curve":"1"},
    "Int 2 (Depth)": {"type": "CC", "controller":19, "curve":"1"},
    "Ramp": {"type": "CC", "controller":20, "curve":"1"},
    "Left Toggle": {"type": "CC", "controller":21, "enum":{"Left":1, "Middle":2, "Right":3}},
    "Middle Toggle": {"type": "CC", "controller":22, "enum":{"Left":1, "Middle":2, "Right":3}},
    "Right Toggle": {"type": "CC", "controller":23, "enum":{"Left":1, "Middle":2, "Right":3}},
    "Hold": {"type": "CC", "controller":24, "enum":{"Off":0, "On":127}},
    "Slowdown Mode": {"type": "CC", "controller":25, "enum":{"Off":0, "On":127}},
    "Clock Ignore": {"type": "CC", "controller":51, "enum":{"Ignore":0, "Listen":127}},
    "Tap": {"type": "CC", "controller":93, "enum":{"Tap":127}},
    "Expression": {"type": "CC", "controller":100, "curve":"1"},
    "Bypass": {"type": "CC", "controller":102, "enum":{"Enabled": 127, "Bypass":0}},
...
"Eventide:H9":{
    ...
    "Key": {"type": "CC", "controller":28, "enum":{"C": 0,
        "C#": 6,
        "D": 19,
        "D#": 29,
        "E": 41,
        ...
        "A#": 109,
        "B": 121}},
    "Scale": {"type": "CC", "controller":29, "enum":{ "Major": 0,
        "Minor": 7,
        "DOR":16,
        "PHRG":27,
        "LYD":37,
...
"DAW:DAW":{
    ...
    "Note On": {"type": "note_on", "value":{"min":0, "max":127}},
    "Note On Off": {"type": "note_on_off", "value":{"min":0, "max":127}},
    "Note Off": {"type": "note_off", "value":{"min":0, "max":127}},
    "Preset": {"type": "PC", "value":{"min":0, "max":127}}
    },
"Line 6:Helix":{
...
"Pigtronix:Echolution 2 Deluxe":{
    ...
    "Bypass Type": {"type": "CC", "controller":21, "enum":{"None":3, "Trails On":4, "Listen On":5, "Dry Kill Off 1":6, "Dry Kill Off 2":7}},
    "Ducking": {"type": "CC", "controller":22, "enum":{"Off":3, "Reverse Only":4, "Duck Only":5}},
    "EXP Button": {"type": "CC", "controller":22, "enum":{"NONE":3,
            "REPEATS":4,
            "TIME":5,
            "MIX":6,
            "SPEED":7,
            "DEPTH":8,
            "ENVELOPE SELECTOR ON": 9,
            "ENVELOPE SELECTOR OFF": 10}},
    ...
    "Preset Save": {"type": "CC", "controller":28, "enum":{"On":127}},
    "Jump": {"type": "CC", "controller":29, "enum":{"One":1, "Two":2}},
    "Freeze": {"type": "CC", "controller":30, "enum":{"One":1, "Two":2}},
    # "Jump": {"type": "CC", "controller":29, "enum":{"4":4, "3":3, "One":1, "Two":2, "Full Off":0, "Full On":127}},
    # "Freeze": {"type": "CC", "controller":30, "enum":{"4":4, "3":3, "One":1, "Two":2, "Full Off":0, "Full On":127}},
    "Loop": {"type": "CC", "controller":31, "enum":{"Loop":1}},
    "Filter Cutoff": {"type": "CC", "controller":74, "curve":"1"},
    "Second Tap Volume": {"type": "CC", "controller":76, "curve":"1"},
    "First Tap Jump": {"type": "CC", "controller":77, "enum":{"Decrement":1, "Increment":2,
            "- Octave": 3,
            "- MAJOR 7th": 4,
            "- MINOR 7th": 5,
            "- MAJOR 6th": 6,
            ...
            "+ MAJOR 7th": 26,
            "+ Octave": 27}},
    "Second Tap Jump": {"type": "CC", "controller":78, "enum":{"Decrement":1, "Increment":2,
            "- Octave": 3,
            "- MAJOR 7th": 4,
            "- MINOR 7th": 5,
            "- MAJOR 6th": 6,
            ...
            "+ MAJOR 7th": 26,
            "+ Octave": 27}},
    "Enabled MIDI Clock In": {"type": "CC", "controller":79, "enum":{"Off":0, "On":1}},
    "Enabled MIDI Clock Out": {"type": "CC", "controller":80, "enum":{"Off":0, "On":1}},
    "Copy MIDI Clock": {"type": "CC", "controller":81, "enum":{"Off":0, "On":1}},
    "Preset": {"type": "PC", "value":{"min":0, "max":127}}
    },
"Empress:Echosystem":{
    "Modes A": {"type": "CC", "controller":100, "enum":{"Digital":0, "Tape":8, "Analog":16,
        "Multi":24, "Mod":32}},
    "Delay Time A": {"type": "CC", "controller":101, "curve":"1"},
    "Mix A": {"type": "CC", "controller":102, "curve":"1"},
    "Volume A": {"type": "CC", "controller":103, "curve":"1"},
    "Feedback A": {"type": "CC", "controller":104, "curve":"1"},
    "Tone A": {"type": "CC", "controller":105, "curve":"1"},
    "Thing 1 A": {"type": "CC", "controller":106, "curve":"1"},
    "Thing 2 A": {"type": "CC", "controller":107, "curve":"1"},
    "Delay Source A": {"type": "CC", "controller":108, "enum":{"Knob":0, "Local":1, "Global":2}},
    "Modes B": {"type": "CC", "controller":109, "enum":{"Digital":0, "Tape":8, "Analog":16,
        "Multi":24, "Mod":32}},
    "Delay Time B": {"type": "CC", "controller":110, "curve":"1"},
    "Mix B": {"type": "CC", "controller":111, "curve":"1"},
    "Volume B": {"type": "CC", "controller":112, "curve":"1"},
    "Feedback B": {"type": "CC", "controller":113, "curve":"1"},
    "Tone B": {"type": "CC", "controller":114, "curve":"1"},
    "Thing 1 B": {"type": "CC", "controller":115, "curve":"1"},
    "Thing 2 B": {"type": "CC", "controller":116, "curve":"1"},
    "Delay Source B": {"type": "CC", "controller":117, "enum":{"Knob":0, "Local":1, "Global":2}},
    "Engage": {"type": "CC", "controller":60, "enum":{"Bypass":0, "On":127}}, # TODO few more to add
    "Solo Engine A": {"type": "CC", "controller":41, "enum":{"Unsolo":0, "Solo":127}}, 
    "Solo Engine B": {"type": "CC", "controller":42, "enum":{"Unsolo":0, "Solo":127}}, 
    "Preset": {"type": "PC", "value":{"min":0, "max":127}}
    },
"Empress:Tremolo2":{
...
"Poly:Expressive":{
    "Start Clock": {"type": "start_clock"},
    "Stop Clock": {"type": "stop_clock"},
    "Continue Clock": {"type": "continue_clock"},
    "Tap": {"type": "tap_clock"},
    "Set Tempo/BPM": {"type": "clock_bpm", "value":{"min":30, "max":300}}
    },
"Strymon:Timeline":{
...
"Strymon:BigSky":{
    "Type encoder": {"type": "CC", "controller":19, "value":{"min":0, "max":11}},
    "Value encoder": {"type": "CC", "controller":20, "enum":{"On": 1, "Off":0}},
    "Decay": {"type": "CC", "controller":17, "curve":"1"},
    "Pre-Delay": {"type": "CC", "controller":18, "curve":"1"},
    "Mix": {"type": "CC", "controller":15, "curve":"1"},
    ...
    "Persist Off/On": {"type": "CC", "controller":22, "enum":{"On": 1, "Off":0}},
    "Freeze/Infinite": {"type": "CC", "controller":70, "enum":{"On": 1, "Off":0}},
    "Expression Off/On": {"type": "CC", "controller":60, "enum":{"On": 1, "Off":0}},
    "MIDI Clock Off/On": {"type": "CC", "controller":71, "enum":{"On": 1, "Off":0}},
    "ROOM - Low End": {"type": "CC", "controller":61, "value":{"min":0, "max":20}},
    "ROOM - Size": {"type": "CC", "controller":59, "enum":{"On": 1, "Off":0}},
    "ROOM - Diffusion": {"type": "CC", "controller":58, "value":{"min":0, "max":20}},
    "HALL - Low End": {"type": "CC", "controller":39, "value":{"min":0, "max":20}},
    "HALL - Size": {"type": "CC", "controller":40, "enum":{"On": 1, "Off":0}},
    "HALL - Mid": {"type": "CC", "controller":42, "value":{"min":0, "max":20}},
    "PLATE - Low End": {"type": "CC", "controller":69, "value":{"min":0, "max":20}},
    "PLATE - Size": {"type": "CC", "controller":68, "enum":{"On": 1, "Off":0}},
    "SPRING - Low End": {"type":"CC", "controller":64, "value":{"min":0, "max":20}},
    "SPRING - Dwell":{"type":"CC", "controller":63, "value":{"min":0, "max":3}},
    "SPRING - # Springs": {"type":"CC", "controller":62, "value":{"min":0, "max":2}},
    "SWELL - Low End":{"type":"CC", "controller":65, "value":{"min":0, "max":20}},
    "SWELL - Rise":{"type": "CC", "controller":66, "value":{"min":0, "max":22}},
    "SWELL - Mode": {"type": "CC", "controller":67, "enum":{"On": 1, "Off":0}},
    "BLOOM - Low End":{"type": "CC", "controller":31, "value":{"min":0, "max":20}},
    "BLOOM - Length":{"type": "CC", "controller":32, "value":{"min":0, "max":17}},
    "BLOOM - Feedback":{"type": "CC", "controller":30, "value":{"min":0, "max":17}},
    "CLOUD - Low End":{"type": "CC", "controller":38, "value":{"min":0, "max":20}},
    "CLOUD - Diffusion":{"type": "CC", "controller":37, "value":{"min":0, "max":20}},
    "CHORALE - Vowel":{"type": "CC", "controller":33, "value":{"min":0, "max":6}},
    "CHORALE - Reso":{"type": "CC", "controller":34, "value":{"min":0, "max":2}},
    "SHIMMER - Shift 1": {"type": "CC", "controller":25, "value":{"min":0, "max":27}},
    "SHIMMER - Shift 2": {"type": "CC", "controller":26, "value":{"min":0, "max":28}},
    "SHIMMER - Amount":{"type": "CC", "controller":27, "value":{"min":0, "max":18}},
    "SHIMMER - Mode":{"type": "CC", "controller":28, "value":{"min":0, "max":2}},
    "SHIMMER - Low End":{"type": "CC", "controller":24, "value":{"min":0, "max":20}},
    "MAGNETO - Low End":{"type": "CC", "controller":55, "value":{"min":0, "max":20}},
    "MAGNETO - Diffusion":{"type": "CC", "controller":56, "value":{"min":0, "max":20}},
    "MAGNETO - Heads":{"type": "CC", "controller":57, "value":{"min":0, "max":2}},
    "MAGNETO - Spacing": {"type": "CC", "controller":54, "enum":{"On": 1, "Off":0}},
    "NONLINEAR - Low End":{"type": "CC", "controller":44, "value":{"min":0, "max":20}},
    "NONLINEAR - Shape":{"type": "CC", "controller":46, "value":{"min":0, "max":5}},
    "NONLINEAR - Diffusion":{"type": "CC", "controller":45, "value":{"min":0, "max":20}},
    "NONLINEAR - Late Decay":{"type": "CC", "controller":47, "value":{"min":0, "max":17}},
    "NONLINEAR - Late Level":{"type": "CC", "controller":48, "value":{"min":0, "max":18}},
    "NONLINEAR - Mod Speed":{"type": "CC", "controller":43, "value":{"min":0, "max":17}},
    "REFLECTIONS - Low End":{"type": "CC", "controller":52, "value":{"min":0, "max":20}},
    "REFLECTIONS - Loc Y": {"type": "CC", "controller":50, "value":{"min":0, "max":6}},
    "REFLECTIONS - Loc X": {"type": "CC", "controller":49, "value":{"min":0, "max":6}},
    "REFLECTIONS - Shape": {"type": "CC", "controller":51, "value":{"min":0, "max":2}},
    "A footswitch": {"type": "CC", "controller":80, "enum":{"On": 127, "Off":0}},
    "B footswitch": {"type": "CC", "controller":82, "enum":{"On": 127, "Off":0}},
    "C footswitch": {"type": "CC", "controller":81, "enum":{"On": 127, "Off":0}},
    "Hold Switch": {"type": "CC", "controller":97, "enum":{"On": 127, "Off":0}},
    "Remote TAP": {"type": "CC", "controller":93, "enum":{"Remote TAP":1}},
    "Expression Pedal": {"type": "CC", "controller":100, "curve":"1"},
    "Bypass": {"type": "CC", "controller":102, "enum":{"Enabled": 1, "Bypass":0}},
    "MIDI Patch Bank": {"type": "CC", "controller":0, "enum":{"1": 1, "0":0}},
...
"Fractal Audio:Axe FX 2":{
    "Input Volume": {"type": "CC", "controller":10, "curve":"1"},
    "Out 1 Volume": {"type": "CC", "controller":11, "curve":"1"},
    "Out 2 Volume": {"type": "CC", "controller":12, "curve":"1"},
    "Bypass": {"type": "CC", "controller":13, "enum":{"On": 127, "Off":0}},
    "Tempo": {"type": "CC", "controller":14, "enum":{"On": 127, "Off":0}},
    "Tuner": {"type": "CC", "controller":15, "enum":{"On": 127, "Off":0}},
    "Control 1":{"type": "CC", "controller":16, "curve":"1"},
    "Control 2":{"type": "CC", "controller":17, "curve":"1"},
    "Control 3":{"type": "CC", "controller":18, "curve":"1"},
    "Control 4":{"type": "CC", "controller":19, "curve":"1"},
    "Control 5":{"type": "CC", "controller":20, "curve":"1"},
    "Control 6":{"type": "CC", "controller":21, "curve":"1"},
    "Control 7":{"type": "CC", "controller":22, "curve":"1"},
    "Control 8":{"type": "CC", "controller":23, "curve":"1"},
    "Control 9":{"type": "CC", "controller":24, "curve":"1"},
    "Control 10":{"type": "CC", "controller":25, "curve":"1"},
    "Control 11":{"type": "CC", "controller":26, "curve":"1"},
    "Control 12":{"type": "CC", "controller":27, "curve":"1"},
    "Looper Record": {"type": "CC", "controller":28, "enum":{"On": 127, "Off":0}},
    "Looper Play": {"type": "CC", "controller":29, "enum":{"On": 127, "Off":0}},
    "Looper Once": {"type": "CC", "controller":30, "enum":{"On": 127, "Off":0}},
    "Looper Dub": {"type": "CC", "controller":31, "enum":{"On": 127, "Off":0}},
    "Looper Rev": {"type": "CC", "controller":32, "enum":{"On": 127, "Off":0}},
    "Looper Bypass": {"type": "CC", "controller":33, "enum":{"On": 127, "Off":0}},
    "Looper Half": {"type": "CC", "controller":120, "enum":{"On": 127, "Off":0}},
    "Looper Undo": {"type": "CC", "controller":121, "enum":{"On": 127, "Off":0}},
    "Metronome": {"type": "CC", "controller":122, "enum":{"On": 127, "Off":0}},
    "Scene Select": {"type": "CC", "controller":34, "enum":{"On": 127, "Off":0}},
    "Scene Increment": {"type": "CC", "controller":123, "enum":{"On": 127, "Off":0}},
    "Scene Decrement": {"type": "CC", "controller":124, "enum":{"On": 127, "Off":0}},
    "Volume Increment": {"type": "CC", "controller":35, "enum":{"On": 127, "Off":0}},
    "Volume Decrement": {"type": "CC", "controller":36, "enum":{"On": 127, "Off":0}},
    "Amp 1 Bypass": {"type": "CC", "controller":37, "enum":{"On": 127, "Off":0}},
    "Amp 2 Bypass": {"type": "CC", "controller":38, "enum":{"On": 127, "Off":0}},
    "Cab 1 Bypass": {"type": "CC", "controller":39, "enum":{"On": 127, "Off":0}},
    "Cab 2 Bypass": {"type": "CC", "controller":40, "enum":{"On": 127, "Off":0}},
    "Chorus 1 Bypass": {"type": "CC", "controller":41, "enum":{"On": 127, "Off":0}},
    "Chorus 2 Bypass": {"type": "CC", "controller":42, "enum":{"On": 127, "Off":0}},
    "Compressor 1 Bypass": {"type": "CC", "controller":43, "enum":{"On": 127, "Off":0}},
    "Compressor 2 Bypass": {"type": "CC", "controller":44, "enum":{"On": 127, "Off":0}},
    "Crossover 1 Bypass": {"type": "CC", "controller":45, "enum":{"On": 127, "Off":0}},
    "Crossover 2 Bypass": {"type": "CC", "controller":46, "enum":{"On": 127, "Off":0}},
    "Delay 1 Bypass": {"type": "CC", "controller":47, "enum":{"On": 127, "Off":0}},
    "Delay 2 Bypass": {"type": "CC", "controller":48, "enum":{"On": 127, "Off":0}},
    "Drive 1 Bypass": {"type": "CC", "controller":49, "enum":{"On": 127, "Off":0}},
    "Drive 2 Bypass": {"type": "CC", "controller":50, "enum":{"On": 127, "Off":0}},
    "Enhancer Bypass": {"type": "CC", "controller":51, "enum":{"On": 127, "Off":0}},
    "Filter 1 Bypass": {"type": "CC", "controller":52, "enum":{"On": 127, "Off":0}},
    "Filter 2 Bypass": {"type": "CC", "controller":53, "enum":{"On": 127, "Off":0}},
    "Filter 3 Bypass": {"type": "CC", "controller":54, "enum":{"On": 127, "Off":0}},
    "Filter 4 Bypass": {"type": "CC", "controller":55, "enum":{"On": 127, "Off":0}},
    "Flanger 1 Bypass": {"type": "CC", "controller":56, "enum":{"On": 127, "Off":0}},
    "Flanger 2 Bypass": {"type": "CC", "controller":57, "enum":{"On": 127, "Off":0}},
    "Formant 1 Bypass": {"type": "CC", "controller":58, "enum":{"On": 127, "Off":0}},
    "FX Loop Bypass": {"type": "CC", "controller":59, "enum":{"On": 127, "Off":0}},
    "Gate/Expander 1 Bypass": {"type": "CC", "controller":60, "enum":{"On": 127, "Off":0}},
    "Gate/Expander 2 Bypass": {"type": "CC", "controller":61, "enum":{"On": 127, "Off":0}},
    "Graphic EQ 1 Bypass": {"type": "CC", "controller":62, "enum":{"On": 127, "Off":0}},
    "Graphic EQ 2 Bypass": {"type": "CC", "controller":63, "enum":{"On": 127, "Off":0}},
    "Graphic EQ 3 Bypass": {"type": "CC", "controller":64, "enum":{"On": 127, "Off":0}},
    "Graphic EQ 4 Bypass": {"type": "CC", "controller":65, "enum":{"On": 127, "Off":0}},
    "Megatap Delay Bypass": {"type": "CC", "controller":66, "enum":{"On": 127, "Off":0}},
    "Multiband Comp 1 Bypass": {"type": "CC", "controller":67, "enum":{"On": 127, "Off":0}},
    "Multiband Comp 2 Bypass": {"type": "CC", "controller":68, "enum":{"On": 127, "Off":0}},
    "Multi-Delay 2 Bypass": {"type": "CC", "controller":69, "enum":{"On": 127, "Off":0}},
    "Multi-Delay 2 Bypass": {"type": "CC", "controller":70, "enum":{"On": 127, "Off":0}},
    "Parametric EQ 1 Bypass": {"type": "CC", "controller":71, "enum":{"On": 127, "Off":0}},
    "Parametric EQ 2 Bypass": {"type": "CC", "controller":72, "enum":{"On": 127, "Off":0}},
    "Parametric EQ 3 Bypass": {"type": "CC", "controller":73, "enum":{"On": 127, "Off":0}},
    "Parametric EQ 4 Bypass": {"type": "CC", "controller":74, "enum":{"On": 127, "Off":0}},
    "Phaser 1 Bypass": {"type": "CC", "controller":75, "enum":{"On": 127, "Off":0}},
    "Phaser 2 Bypass": {"type": "CC", "controller":76, "enum":{"On": 127, "Off":0}},
    "Pitch Shifter 1 Bypass": {"type": "CC", "controller":77, "enum":{"On": 127, "Off":0}},
    "Pitch Shifter 2 Bypass": {"type": "CC", "controller":78, "enum":{"On": 127, "Off":0}},
    "Quad Chorus 1 Bypass": {"type": "CC", "controller":79, "enum":{"On": 127, "Off":0}},
    "Quad Chorus 2 Bypass": {"type": "CC", "controller":80, "enum":{"On": 127, "Off":0}},
    "Resonator 1 Bypass": {"type": "CC", "controller":81, "enum":{"On": 127, "Off":0}},
    "Resonator 2 Bypass": {"type": "CC", "controller":82, "enum":{"On": 127, "Off":0}},
    "Reverb 1 Bypass": {"type": "CC", "controller":83, "enum":{"On": 127, "Off":0}},
    "Reverb 2 Bypass": {"type": "CC", "controller":84, "enum":{"On": 127, "Off":0}},
    "Ring Modulator Bypass": {"type": "CC", "controller":85, "enum":{"On": 127, "Off":0}},
    "Rotary 1 Bypass": {"type": "CC", "controller":86, "enum":{"On": 127, "Off":0}},
    "Rotary 2 Bypass": {"type": "CC", "controller":87, "enum":{"On": 127, "Off":0}},
    "Synth 1 Bypass": {"type": "CC", "controller":88, "enum":{"On": 127, "Off":0}},
    "Synth 2 Bypass": {"type": "CC", "controller":89, "enum":{"On": 127, "Off":0}},
    "Tone Matching": {"type": "CC", "controller":99, "enum":{"On": 127, "Off":0}},
    "Tremolo 1 Bypass": {"type": "CC", "controller":90, "enum":{"On": 127, "Off":0}},
    "Tremolo 2 Bypass": {"type": "CC", "controller":91, "enum":{"On": 127, "Off":0}},
    "Vocoder Bypass": {"type": "CC", "controller":92, "enum":{"On": 127, "Off":0}},
    "Volume/Pan 1 Bypass": {"type": "CC", "controller":93, "enum":{"On": 127, "Off":0}},
    "Volume/Pan 2 Bypass": {"type": "CC", "controller":94, "enum":{"On": 127, "Off":0}},
    "Volume/Pan 3 Bypass": {"type": "CC", "controller":95, "enum":{"On": 127, "Off":0}},
    "Volume/Pan 4 Bypass": {"type": "CC", "controller":96, "enum":{"On": 127, "Off":0}},
    "Wahwah 1 Bypass": {"type": "CC", "controller":97, "enum":{"On": 127, "Off":0}},
    "Wahwah 2 Bypass": {"type": "CC", "controller":98, "enum":{"On": 127, "Off":0}},
    "Amp 1 X/Y": {"type": "CC", "controller":100, "enum":{"On": 127, "Off":0}},
    "Amp 2 X/Y": {"type": "CC", "controller":101, "enum":{"On": 127, "Off":0}},
    "Cab 1 X/Y": {"type": "CC", "controller":102, "enum":{"On": 127, "Off":0}},
    "Cab 2 X/Y": {"type": "CC", "controller":103, "enum":{"On": 127, "Off":0}},
    "Chorus 1 X/Y": {"type": "CC", "controller":104, "enum":{"On": 127, "Off":0}},
    "Chorus 2 X/Y": {"type": "CC", "controller":105, "enum":{"On": 127, "Off":0}},
    "Delay 1 X/Y": {"type": "CC", "controller":106, "enum":{"On": 127, "Off":0}},
    "Delay 2 X/Y": {"type": "CC", "controller":107, "enum":{"On": 127, "Off":0}},
    "Drive 1 X/Y": {"type": "CC", "controller":108, "enum":{"On": 127, "Off":0}},
    "Drive 2 X/Y": {"type": "CC", "controller":109, "enum":{"On": 127, "Off":0}},
    "Flanger 1 X/Y": {"type": "CC", "controller":110, "enum":{"On": 127, "Off":0}},
    "Flanger 2 X/Y": {"type": "CC", "controller":111, "enum":{"On": 127, "Off":0}},
    "Phaser 1 X/Y": {"type": "CC", "controller":112, "enum":{"On": 127, "Off":0}},
    "Phaser 2 X/Y": {"type": "CC", "controller":113, "enum":{"On": 127, "Off":0}},
    "Pitch 1 X/Y": {"type": "CC", "controller":114, "enum":{"On": 127, "Off":0}},
    ...
    "Blend": {"type": "CC", "controller":14, "curve":"1"},
    "Decay/Time": {"type": "CC", "controller":15, "curve":"1"},
    "Param": {"type": "CC", "controller":16, "curve":"1"},
    "Intensity/Repeats": {"type": "CC", "controller":17, "curve":"1"},
    "Load Patch A": {"type": "CC", "controller":18, "enum":{"On": 127}},
    "Load Patch B": {"type": "CC", "controller":19, "enum":{"On": 127}},
    "Bank Down": {"type": "CC", "controller":20, "enum":{"On": 127}},
    "Bank Up": {"type": "CC", "controller":21, "enum":{"On": 127}},
    "Bypass": {"type": "CC", "controller":22, "enum":{"Bypass":0, "Enabled": 127}},
    "Kill Dry": {"type": "CC", "controller":23, "enum":{"Off":0, "On": 127}},
    "Aux-Out Switch": {"type": "CC", "controller":24, "enum":{"Off":0, "On": 127}},
    "Tap": {"type": "CC", "controller":25, "enum":{"On": 127}},
    "Preset": {"type": "PC", "value":{"min":0, "max":31}}
    },
    "GFI System:Cabzeus":{
...
"Chase Bliss:Condor": {
    ...
    "Toggle Drive":  ["Bypass", "on_foot_down_toggle", "Enabled", "Bypass", "Drive Off Engaged"]
    },
"Chase Bliss:Gravitas": {
    "Toggle Enabled":  ["Bypass", "on_foot_down_toggle", "Enabled", "Bypass", "Bypass"]
    },
...
"Chase Bliss:Thermae": {
    "Toggle Enabled":  ["Bypass", "on_foot_down_toggle", "Enabled", "Bypass", "Bypass"],
    "Toggle Hold":  ["Hold", "on_foot_down_toggle", "On", "Hold", "Off"]
    },
"Chase Bliss:Warped Vinyl 2": {
    "Toggle Enabled":  ["Bypass", "on_foot_down_toggle", "Enabled", "Bypass", "Bypass"]
    },
...
"Empress:Phaser":{
    "Toggle Bypass": ["Engage", "on_foot_down_toggle", "On", "Engage", "Bypass"],
    "Exit Direct On Up": ["Exit Direct", "on_foot_up", "Exit"]
    },
"Meris:Mercury 7":{
...
"Poly:Expressive":{
    "Start MIDI Clock": ["Start Clock", "on_foot_down", 1],
    "Stop MIDI Clock": ["Stop Clock", "on_foot_down", 1],
    "Tap Tempo": ["Tap", "on_foot_down", 1],
    "Continue MIDI Clock": ["Continue Clock", "on_foot_down", 1],
    }
}
